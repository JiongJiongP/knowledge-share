# Step 2: ContentCreate Page Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Replace the ContentCreate.vue placeholder with a full content creation page matching `ui/index.html` design, including type selector, markdown editor with toolbar, tag selector, group publishing, and scheduled publish.

**Architecture:** Single Vue 3 SFC using Composition API. Reuses `TagSelector.vue` for tag picking and `AppHeader.vue` for navigation. Toolbar inserts markdown syntax into textarea. API calls to `createContent`, `saveDraft`, `publishContent`, `getGroupList`.

**Tech Stack:** Vue 3 + Element Plus + existing Axios API layer (no new dependencies)
...
| Action | File | Purpose |
|--------|------|---------|
| Replace | `frontend/src/views/ContentCreate.vue` | Full page implementation |

---

### Task 1: Implement ContentCreate page

**Files:**
- Replace: `frontend/src/views/ContentCreate.vue`

- [ ] **Step 1: Write the full ContentCreate.vue**
...
```bash
git add frontend/src/views/ContentCreate.vue
git commit -m "feat: implement ContentCreate page with markdown editor and group publishing"
```
